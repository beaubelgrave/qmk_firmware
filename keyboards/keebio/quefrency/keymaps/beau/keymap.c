...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_with_macro(
    ...
    KC_HOME, KC_END,  KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_ENT, \
    KC_INS,  KC_DEL,  KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_RSFT, \
    _______,  _______,  KC_LCTL, KC_LALT, MO(_FN1), KC_LGUI, KC_SPC,      MO(_FN1),MO(_FN1),  KC_RCTL, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
  ),
